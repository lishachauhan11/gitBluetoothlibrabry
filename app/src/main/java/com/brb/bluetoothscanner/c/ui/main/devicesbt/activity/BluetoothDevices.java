...
public class BluetoothDevices extends AppCompatActivity {
    ...
    LinearLayout buttonDesc, buttonPaired, startScanStrengthButton;
    ...
    private void initObj() {
        ...
        buttonPaired = findViewById(R.id.buttonPaired);
        backbutton = findViewById(R.id.backbutton);
        startScanStrengthButton = findViewById(R.id.startScanStrengthButton);
    ...
    protected void onStart() {
        ...
        buttonPaired.setOnClickListener(clicked);
        startScanStrengthButton.setOnClickListener(clicked);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.buttonPaired:
                    ...
                    if (!is_hide_ads) {
                        boolean is_online = eu_consent_Class.isOnline(BluetoothDevices.this);
                        if (is_online) {
                  ...
                  /*  Intent intent1 = new Intent(BluetoothDevices.this, PairedDeviceActivity.class);
                    startActivity(intent1);*/
                    break;
                case R.id.buttonDesc:
                    makeDiscoverable();
                    break;
                case R.id.startScanStrengthButton:
                    click="scan";
                   ...
                   /* Intent intent2 = new Intent(BluetoothDevices.this, SearchStregthActivty.class);
            ...
            if (is_online) {
                ...
                if (is_eea_user) {
                    ...
                    if (is_consent_set) {
                        ...
                        eu_consent_Class.DoConsentProcess(this, BluetoothDevices.this);
                    }
                } else {
                    AdsProcess();
                }
    ...
    public void nextscreen() {
        ...
        else if(click.equals("paired")){
            Intent intent1 = new Intent(BluetoothDevices.this, PairedDeviceActivity.class);
            startActivity(intent1);
        }else if(click.equals("scan")){
            Intent intent2 = new Intent(BluetoothDevices.this, SearchStregthActivty.class);
            startActivity(intent2);
        }
    }
